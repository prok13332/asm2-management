...
app.config(function ($routeProvider) {
    $routeProvider
        ...
        .when("/detail/:id", { templateUrl: "sanpham_chitiet.html", controller: "myCtrl" },)
        .when("/mien_bac", { templateUrl: "mien_bac.html", controller: "myCtrl" },)
        .when("/mien_nam", { templateUrl: "mien_nam.html", controller: "myCtrl" },)
        .when("/mien_trung", { templateUrl: "mien_trung.html", controller: "myCtrl" },)
...
app.controller('SignUpController', function ($scope, $http, $window, $rootScope) {
